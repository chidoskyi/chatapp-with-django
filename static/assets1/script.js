...
//     // Fetch stories on story click
//     document.querySelectorAll('.story').forEach((storyElement, index) => {
//         storyElement.addEventListener('click', function() {
//             const storyIndex = parseInt(this.dataset.storyIndex);
//             const storyUrl = this.dataset.storyUrl; // Fetch the URL from the data attribute
//             currentStoryIndex = storyIndex;
//             fetchStories(storyUrl, storyIndex);
//         });
//     });

//     function showStoryModal(index) {
//         if (index >= 0 && index < storiesList.length) {
//             const story = storiesList[index];
//             modalImage.src = story.content; // Adjust this based on your JSON structure
...
//             currentStoryIndex--;
//             showStoryModal(currentStoryIndex);
//         }
//     });
...
//     function fetchStories(url, index) {
//         fetch(url)
...
document.addEventListener('DOMContentLoaded', function() {
    const stories = document.querySelectorAll('.story[data-story-index]');
    const modalImage = document.getElementById('modalImage');
    const prevButton = document.getElementById('prevButton');
    const nextButton = document.getElementById('nextButton');
    let currentStoryIndex = 0;
    ...
    function showStoryModal(index) {
        ...
        const storyUrl = story.getAttribute('data-story-url');
